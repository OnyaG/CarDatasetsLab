...
Точность модели с оптимизаторам Adam составила 20%.
Точность модели с оптимизатором AdaMax составила 14%.

Точность обиех моделей получилась низкой. Это связано с большим размером batch (128).
